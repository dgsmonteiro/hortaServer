...
const char* ssid = "DGSLINK"; // Nome da rede
const char* password = "asterisco"; // Senha da rede
const char* websockets_server_host = "10.0.0.250"; // IP do servidor websocket
const int websockets_server_port = 3030; // Porta de conexão do servidor
